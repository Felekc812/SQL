...
CREATE INDEX IF NOT EXISTS inx_person_visits_person_id ON person_visits(person_id);
CREATE INDEX IF NOT EXISTS inx_person_visits_pizzeria_id ON person_visits(pizzeria_id);
